...
Cardinal now has a v2 foundation: Home, Money, Invest, Learn, Plan, and Profile provide a stable product structure; Money exposes the existing credit-card experience and a calculators hub; Learn includes introductory credit, savings, and investing lessons; and Profile can provide optional context to the first transparent Cardinal Plan rules. The compound-growth calculator is the first user-facing calculator slice. Additional calculator forms, broader financial workflows, connected accounts, and richer profile and Plan capabilities remain future work. The architecture, safeguards, and phased roadmap are in [Cardinal v2 foundation](CARDINAL_V2.md).
